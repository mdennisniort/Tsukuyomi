...
export class XiboClient {
    ...
    accessToken() {
        ...
        return this.call('POST', `/api/authorize/index.php/access_token`, null, headers, `client_secret=${this.clientSecret}&client_id=${this.clientId}&grant_type=client_credentials`).then(res => {
            console.log("res ", res);
    ...
    clock() {
        return this.accessToken().then(accessTokenValue => {
            ...
            return this.call('GET', '/api/clock', accessTokenValue, {
